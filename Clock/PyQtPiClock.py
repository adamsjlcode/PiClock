...
from PyQt5.QtGui import QMovie, QPixmap, QPainter, QBrush, QColor, QTransform
...
def wxfinished():
    ...
    wxstr = str(wxreply.readAll(), encoding='utf-8')
...
class Radar(QtWidgets.QLabel):
    ...
    def getbase(self):
        ...
        # QtCore.QObject.con(self.basereply, QtCore.SIGNAL(
